...
# Import DLL files
dilithium_dll_path = os.path.join(os.getcwd(), "C:\Users\DELL\Downloads\Modify\tutorWebSite\app1\test_dilithium_2.dll")
oqs_dll_path = os.path.join(os.getcwd(), "liboqs.dll")
...
try:
    ...
    keygen.argtypes = [c_char_p, c_char_p]
    keygen.restype = None
...
# Call functions
def call_keygen(publicKeyFile, privateKeyFile):
    try:
